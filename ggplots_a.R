...
################################################################################
################################################################################
cross.new <- sim.geno(cross_NEW, n.draws = 100, step = 1, off.end = 1, error.prob = 0.001,
  map.function = "kosambi", stepwidth = "fixed")

cross.brp <- sim.geno(cross_BRP, n.draws = 100, step = 1, off.end = 1, error.prob = 0.001,
  map.function = "kosambi", stepwidth = "fixed")

cross.nbh <- sim.geno(cross_NBH, n.draws = 100, step = 1, off.end = 1, error.prob = 0.001,
  map.function = "kosambi", stepwidth = "fixed")

cross.elr <- sim.geno(cross_ELR, n.draws = 100, step = 1, off.end = 1, error.prob = 0.001,
  map.function = "kosambi", stepwidth = "fixed")
################################################################################
################################################################################
