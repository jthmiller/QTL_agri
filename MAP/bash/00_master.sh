...
##sbatch -J "BRP_$SLURM_ARRAY_TASK_ID"  04_QTL.sh 'BRP'
##sbatch -J "NEW_$SLURM_ARRAY_TASK_ID"  04_QTL.sh 'NEW'
##sbatch -J "ELR_M_$SLURM_ARRAY_TASK_ID"  04_QTL.sh 'ELR.missing'
