...
bashsc="$HOME/QTL_agri/MAP/bash"
sbatch -J "EMB.NBH" --mem=60G -p high -t 13:00:00 $bashsc/07_bin_em_scan2.sh 'NBH' 22
...
sbatch -J "NIMP.NBH" --mem=60G -p high -t 13:00:00 $bashsc/07_norm_imp_scan2.sh 'NBH' 22
