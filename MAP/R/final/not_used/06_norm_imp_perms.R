...
assign(paste0("norm.imp.perms.2.",arraynum), norm.imp.perms.2)
assign(paste0("norm.imp.perms.1.",arraynum), norm.imp.perms.1)
...
################################################################################
save.image(file.path(mpath,paste0(pop,arraynum,'_scan_perms_norm_imp.rsave')))
################################################################################
